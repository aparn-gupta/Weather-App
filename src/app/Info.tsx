  ...
  return (
   ...
   <div className="flex h-20"> <img  src='https://www.fpl.com/content/dam/fplgp/us/en/icons/air-blue-icon.png' alt='windspeed-icon' className='w-12 h-12 mt-4 '/> <p className='mt-4 ml-4 text-sm'> Wind Speed :  <span className='text-lg font-bold' >{windSpeed ? `${windSpeed}Km/h` : "Data N/A"}</span>  </p> </div>
     ...
     <div className='w-full flex justify-center mt-6'>
      ...
      <div className="flex h-20"> <img  src='https://img.genial.ly/5ea5b2dcd331670fb93482a4/6e94be44-eb70-4b50-b909-0eea88d93033.png' alt='rain-intensity-icon' className='w-8 h-8 mt-4'/>  <p className='  mt-6 ml-2 text-xs'> Rain Intensity :  <span className=' font-bold'>{ rainIntensity ?  `${rainIntensity}mm/h` :  "Data N/A" }</span> </p> </div>
